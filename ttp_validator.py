...
if __name__ == '__main__':
    ...
    instance = TTPInstance(file_name)
    print(instance.problem_name)
    print(instance.knapsack_data_type)
    print(instance.dimension)
    print(instance.number_of_items)
    print(instance.capacity_of_knapsack)
    print(instance.min_speed)
    print(instance.max_speed)
    print(instance.renting_ratio)
    print(instance.edge_weight_type)
    print(instance.xy)
    print(instance.wp)

    solution = open(solution_file, 'r')
    seq, sub = map(eval, solution.readlines())
    print(instance.eval_solution(seq, sub))
